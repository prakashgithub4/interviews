                 ...
                 @endif
                    ...
                    <form method="POST" action="{{ route('signup') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_no" type="text" class="form-control @error('phone_no') is-invalid @enderror" name="phone_no" value="{{ old('phone_no') }}"  autocomplete="mobile">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="radio" name="gender" value="male" value="male"/>Male<input type="radio" name="gender" value="female"/>Female
